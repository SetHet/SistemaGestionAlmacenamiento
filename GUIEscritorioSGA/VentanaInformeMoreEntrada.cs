...
{
    public partial class VentanaInformeMoreEntrada : Form
    {
        #region Parametros
        ...
        private void CargarProductos()
        {
            ...
            {
                //Todas las Bodegas
                ListaProductoCantidad = AuxServiceProducto.GetCantidadProductoEntrada().ToList();
            }
            else
            {
                //Bodega especificada
                int id_bodega = ListaBodegas[ComboBox_Bodegas.SelectedIndex - 1].IdBodega;
                ListaProductoCantidad = AuxServiceProducto.GetCantidadProductoEntradaByBodega(id_bodega).ToList();
            }
