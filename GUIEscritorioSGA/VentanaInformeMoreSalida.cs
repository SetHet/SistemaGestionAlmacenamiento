...
{
    public partial class VentanaInformeMoreSalida : Form
    {
        #region Parametros
        ...
        public VentanaInformeMoreSalida()
        {
            InitializeComponent();
            CargarContenido();
        }
        ...
        private void CargarProductos()
        {
            ...
            {
                //Todas las Bodegas
                ListaProductoCantidad = AuxServiceProducto.GetCantidadProductoSalida().ToList();
            }
            else
            {
                //Bodega especificada
                int id_bodega = ListaBodegas[ComboBox_Bodegas.SelectedIndex - 1].IdBodega;
                ListaProductoCantidad = AuxServiceProducto.GetCantidadProductoSalidaByBodega(id_bodega).ToList();
            }
